...
points(seq(489,508,1),preds$pred,type="b",pch=15)
...
preds2        
plot(seq(1,508,1),data$cmort,type="l")
points(seq(489,508,1),preds2$pred,type="b",pch=15)
...
# plot the data
plot(seq(1,508,1),data$cmort,type="l")
points(seq(489,508,1),predVAR,type="b",pch=15)
